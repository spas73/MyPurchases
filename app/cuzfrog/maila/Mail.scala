...
import cuzfrog.utils.SimpleLogger
...
//    lazy val receiveDate: LocalDate = message.getReceivedDate match {
//      case null =>
...
//    }
    ...
    lazy val subject: String = message.getSubject
    lazy val contentMime: AnyRef = message.getContent
    lazy val contentType: String = message.getContentType
    lazy val contentText: String = parseMime(message)
    lazy val recipients: Seq[String] = message.getAllRecipients.toSeq.map(_.toString)
